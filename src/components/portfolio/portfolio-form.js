...
export default class PortofolioForm extends Component {
    constructor(props) {
      super(props);
      ...
      this.state = {
        ...
        logo: "",
        editMode: false,
        apiUrl: "https://zkoryami.devcamp.space/portfolio/portfolio_items",
        apiAction: "post"
      }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://zkoryami.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
